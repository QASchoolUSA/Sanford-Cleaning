  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full select-none p-0 text-center touch-manipulation",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "flex aspect-square h-auto w-full min-w-[--cell-size] min-h-[--cell-size] flex-col gap-1",
