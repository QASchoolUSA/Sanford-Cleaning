        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 md:p-10 text-center">
              ...
              <div className="mt-6 rounded-xl bg-blue-50 border border-blue-100 px-5 py-4 text-left">
              ...
              <p className="text-gray-600 mt-6">
                Questions? Call{" "}
                <a href="tel:321-236-0618" className="text-blue-600 underline hover:text-blue-800">(321) 236-0618</a>
                {" "}or email{" "}
                <a href="mailto:info@sanfordcleaning.com" className="text-blue-600 underline hover:text-blue-800">info@sanfordcleaning.com</a>.
              </p>
            </div>
          </div>
        </div>
